...
int main()
{
    ...
    std::cout << "get_num() = " << sf_int.get_count() << "\n";
    std::cout << "\n";
    ...
    std::cout << "get_num() = " << sf_char.get_count() << "\n";
    std::cout << "\n";
